            ...
            <div className="mt-20 flex justify-center items-center">
                <form className="max-w-sm mx-auto grow">
                    ...
                    <div className="mb-5">
                        ...
                        <input value={formData.password} onChange={handleChange} name="password" type="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    ...
                    {emailVerified && (
                        <div className="mt-3 bg-red-400 text-sm text-center p-5 border rounded-lg">
                    ...
                    {mailSent && (
                        <div className="mt-3 bg-green-400 text-sm text-center p-5 border rounded-lg">We have sent you a mail please check your mail box</div>
                    )}
                </form>
            </div>
        </>
